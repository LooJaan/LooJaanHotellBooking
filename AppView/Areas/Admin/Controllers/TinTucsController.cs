...

{
    ...
    public class TinTucsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,TenTinTucChinh,HinhAnh,NoiDungNgan,NoiDungChiTiet,TrangThai")] TinTuc tinTuc, IFormFile hinhanh)
        {
		...
		[IgnoreAntiforgeryToken]
		[ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,TenTinTucChinh,HinhAnh,NoiDungNgan,NoiDungChiTiet,TrangThai")] TinTuc tinTuc, IFormFile imageFile)
        {
            if (id != tinTuc.ID)
            {
                return NotFound();
